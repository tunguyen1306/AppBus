...
public class USBAdapter{
    ...
    public  void  showDeviceList(Context context)
    {
        mUsbManager = (UsbManager) context.getSystemService(Context.USB_SERVICE);

         HashMap<String,UsbDevice>  listMap= mUsbManager.getDeviceList();
        String data="";
        for (UsbDevice usb:listMap.values())
        {
            data+=""+ usb.getVendorId()+"-"+usb.getProductId()+"\r\n";
                           ...
                           new Thread(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    Integer b = connection.bulkTransfer(mEndpointBulkOut, s.getBytes(), s.getBytes().length, 10000);
